...
class incident_model extends Model{
    ...
    function insertReport1($id, $noOfelephant, $placeStatus,$photo,$place , $latitude,$longitude){
        ...
        foreach( $data as $row){
         ...
         if($_SESSION['jobtype']=='villager'){ 
             ...
             $this->db->runQuery("INSERT INTO `reported_incident`(`incidentID`,`gramaniladari_NIC`,`villager_NIC`,  `village_code`, `officeNo`,`time_in`, `date`, `image`, `status`, `description`,`Place`, `lat`, `lon`,`reporttype`) VALUES ( '', '$id' ,'$id' , '$villagerCode' ,$officeNo,  '$time', '$date', '$photo','pending','','$place',' $latitude','$longitude','Wild Elephant are in The Village' )"); 
        } 
    ...
    function insertReport3($id,$photo,$place,$latitude,$longitude){
        ...
        if($_SESSION['jobtype']=='villager'){ 
            ...
            $this->db->runQuery("INSERT INTO `reported_incident`(`incidentID`,`gramaniladari_NIC`,`villager_NIC`,  `village_code`, `officeNo`,`time_in`, `date`, `image`, `status`, `description`,`Place`, `lat`, `lon`,`reporttype`) VALUES ( '', '$id' ,'$id' , '$villagerCode' ,$officeNo,  '$time', '$date', '$photo','pending','','$place',' $latitude','$longitude','Breakdown of Elephant Fence' )");  
        }
    }
    ...
    function insertReport5($id,$animal,$noOfanimals,$support,$discription,$photo,$place,$latitude,$longitude){
        ...
        if($_SESSION['jobtype']=='villager'){ 
            ...
            $this->db->runQuery("INSERT INTO `reported_incident`(`incidentID`,`gramaniladari_NIC`,`villager_NIC`,  `village_code`, `officeNo`,`time_in`, `date`, `image`, `status`, `description`,`Place`, `lat`, `lon`,`reporttype`) VALUES ( '', '$id' ,'$id' , '$villagerCode' ,$officeNo,  '$time', '$date', '$photo','pending','','$place',' $latitude','$longitude','Wild Animal Danger' )");  
        }      
