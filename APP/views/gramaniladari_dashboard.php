...
<body style="background-image: none; background-color: white;">
    <header id="main">
        ...
        <nav id="navbar" class="mybar">
            ...
            <ul>
                ...
                <li id="dashboard"><a href="../gramaniladari/viewDashboard">DASHBOARD</a></li>
                <li class="dropdown">
    ...
    <div class="province-report">
        <div class="linechart">
            <h3>Report cropdamages Polonnaruwa </h3>
            <div class="mychart">
        ...
        <div class="chart2">
            <h3>Province of cropdamages Reports </h3>
            <div class="mychart">
