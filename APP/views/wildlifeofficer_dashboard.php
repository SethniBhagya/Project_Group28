...
<body style="background-image: none; background-color: rgba(164, 255, 228, 0.624);">
    ...
    <div class="main-update-col-2">
        ...
        <div class="specialNotice">
           <a> SpecialNotice<img src="../Public/images/bell.png" alt="1" srcset="" id="bell"> </a>
        </div>
        <div class="detail">
    ...
    <div class="district-report">
         ...
         <div class="elephant-injery">
            ...
            <div class="update-col">
                Percentage of Polonnaruwa incidents Report <h1  data-target="90"  class="count">0 </h1><h2>%</h2>
            </div> 
         </div>
         <div class="header-name-1"><pre  style="font-size: larger;font-style: normal; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;"><h>Polonnaruwa District            LastModified 30/09/2021</h></pre></h> </div>
