...
<head>
    ...
    <link rel="stylesheet" href="../Public/css/report_1Update.css">  
...
<body>
    ...
    <div id="myview" class="view-1">
      ...
      ?>
                <h3 style="color: white;"> <b> Illegal Thing happening in the Forest<br><br>Report Number :<?php echo "  " . $_GET['reportNo']; ?> </b></h3>
                </div>
