...
<head>
    ...
    <link rel="stylesheet" href="../Public/css/report_2_update.css">
...
<body>
    ...
    <div class="container1-1">
        <div class="header">
            <b>மற்ற காட்டு விலங்குகள் கிராமத்தில் உள்ளன <br><br>அறிக்கை எண் :<?php echo "  " . $_GET['reportNo']; ?> </b>
        </div>
        <?php
        ...
        <form class="form-report" action="" method="post">
            <div class="form-rp">
                ...
                <input type="number" name="noOfanimals" id="number" value="<?php echo $noOfanimals; ?>"> <br><br>
                ...
                <textarea class="text" id="discription" name="discription" rows="2" value="<?php echo $description ?>"><?php echo $description ?></textarea>
                <div class="photo">
