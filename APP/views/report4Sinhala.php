...
<?php }else{
   ...
   ?>        <?php if (isset($_POST['Submit'])) {
    ...
    <div class="container1-1">
        ...
        <div class="form-rp">
                <label><b>වගා හානියට හේතු වූ සතා :</b></label>
                ...
                <label for="Cultivated Crop"><b>වගා කරන බෝග: </b></label>
                <input type="text" name="cultivatedCrop" id="cCrop"> <br><br>
                <label for="Culktivatedland"><b>වගා කරන  ප්‍රමාණය : </b></label>
                <input type="text" name="cultivatedLand" id="eCrop"> <br><br>
                <label for="Damagedland"><b>හානියට පත්  ප්‍රමාණය : </b></label>
