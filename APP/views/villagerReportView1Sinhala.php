...
<body>
        ...
        <nav id="navbar" class="mybar">
            ...
            <li id="home_2"><a href="../?lang=2">මුල් පිටුව</a></li>
                ...
                <div class="dropdown-1" style="  padding-left:  300px ">
                    <button style="margin-right:10px;  margin-top:  -50px;   " class="dropbtn-1">භාෂාව</button>
    ...
    <div class="container_3">
        ...
        <div class="navigatereport">
                ...
                <a href="?type=1&page=1&lang=2" class="allreport"  style=" background-color: rgb(168, 175, 168);" >සියලුම වාර්තා බලන්න</a>
            
             
                <a href="?type=2&page=1&lang=2" class="myreportaccept" > තහවුරු වර්තා</a>
        ...
        <div class="subcontainer_3-3">
            <!-- <div class="search-container"> -->
                <form action="" class="search-container"  method="POST">
                    ...
                    <option style="padding-right:0px" value="">  තෝරන්න</option> 
