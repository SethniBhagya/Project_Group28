  ...
  <div id="myview" class="view-1">
    <div class="subcontainer_3-5">
      <div class="subcontainer_3-6">
        ...
        ?>
        <h3 style="color: white;"> <b>වන සත්ව අනතුර<br><br>වාර්තා අංකය :<?php echo "  " . $_GET['reportNo']; ?> </b></h3>
      </div>
        ...
        <div id="detail">
          <form class=" " action="../incident/viewReport?lang=1&page=<?php echo $_GET['page'] ?>&type=<?php echo $_GET['type'] ?>" method="post">
            <table class="table">
              ...
              <tr class="header-table" style="text-align: left;">
                <th>පශු වෛද්ය සහාය </th>
                <td> අවශ්යයි <input type="radio" name="support" value="yes" <?php if ($status == "yes") {
                                                                            echo "checked";
                                                                          } ?> id=""> අවශ්ය නැහැ<input type="radio" name="support" id="" value="no" <?php if ($status == "no") {
                                                                                                                                                                      echo "checked";
                                                                                                                                                                    } ?>><br><br>
