         ...
         if (isset($_GET['ratingstatus'])) {
          ...
          ?>
            ...
            <div id="rating" style="padding: 10px;  ">
                ...
                <div class="stars">
                <input type="radio"  name="stars" value="1" style="accent-color: green;" <?php if($row['stars']==1){ echo "checked"; } ?>/>
                <label for="1star">☆</label>
                <input type="radio"  name="stars" value="2"  style="accent-color: green;" <?php if($row['stars']==100){ echo "checked"; } ?>/>
                <label for="2star">☆☆</label>
                <input type="radio"  name="stars" value="3"  style="accent-color: green;"  <?php if($row['stars']==3){ echo "checked"; } ?> />
                <label for="3star">☆☆☆</label> 
                <input type="radio"  name="stars" value="4"  style="accent-color: green;" <?php if($row['stars']==4){ echo "checked"; } ?> />
                <label for="4star">☆☆☆☆</label>
                <input type="radio"  name="stars" value="5"  style="accent-color: green;" <?php if($row['stars']==5){ echo "checked"; } ?> />
