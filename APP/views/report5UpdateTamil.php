  ...
  <div id="myview" class="view-1">
    <div class="subcontainer_3-5">
      <div class="subcontainer_3-6">
        ...
        ?>
        <h3 style="color: white;"> <b>காட்டு விலங்கு ஆபத்து<br><br>அறிக்கை எண் :<?php echo "  " . $_GET['reportNo']; ?> </b></h3>
      </div>
        ...
        <div id="detail">
          <form class=" " action=""  method="post">
            <table class="table">
              ...
              <tr class="header-table" style="text-align: left;">
                <th>கால்நடை ஆதரவு </th>
                <td> தேவை <input type="radio" name="support" value="yes" <?php if ($status == "yes") {
                                                                            echo "checked";
                                                                          } ?> id=""> தேவை இல்லை <input type="radio" name="support" id="" value="no" <?php if ($status == "no") {
                                                                                                                                                    echo "checked";
                                                                                                                                                  } ?>><br><br>
