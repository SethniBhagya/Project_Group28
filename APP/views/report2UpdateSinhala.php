    ...
    <div id="myview" class="view-1">
        <div class="subcontainer_3-5">
            <div class="subcontainer_3-6">
                ...
                ?>
                <h3 style="color: white;"> <b>අනෙකුත් වන සතුන් ද ගම්මානයේ සිටිති<br><br>වාර්තා අංකය :<?php echo "  " . $_GET['reportNo']; ?> </b></h3>
            </div>


            <div id="map" style="top: 100px;top:10px">
                ...
                <div id="detail">
                    ...
                    <option value="Other">වෙනත්</option>              </td>
                            </tr>
                            <tr class="header-table" style="text-align: left;">
                                <th>ස්ථානයේ නම </th>
