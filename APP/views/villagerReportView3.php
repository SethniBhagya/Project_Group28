...
<body>
    ...
    <div class="container_3">
        ...
        <div class="navigatereport">
                ...
                <a href="?type=2&lang=1&page=1" class="myreportaccept" >My Report Accept</a>
             
                 <a href="?type=3&page=1&lang=1" class="myreportpending" style=" background-color: rgb(168, 175, 168);" >My Report Pending</a>
          </div>
