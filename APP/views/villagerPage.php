...
<head>
    ...
    <script src="../Public/Javascript/villager.js"></script>
...
<body>
    ...
    <div class="name">
        <span class="dot2"><img src="../Public/images/user_icon.png" id="user-icon2" ></span><label><b><?php echo $data["NIC"]?></b></label>
    </div>
    <div class="main-view">
    <button class="report">
       <h1> Report </br>! </h1>
