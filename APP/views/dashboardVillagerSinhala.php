...
<body style="background-image: none; background-color: rgba(236, 242, 240, 0.624);">
    ...
    <div class="header-name"><h >ලංකාවේ මුළු එකතුව </h><h style="float:right">අවසන් වරට වෙනස් කළේ 30/09/2021</h></div>
    ...
    <div class="main-update-col-1">
        <div class="last-week">
          ගිය සතිය  <div class="last-week-number"><h1 data-target="10"  class="count">0</h1><p> සිදුවීම් </p></div>
        </div>
        <div class="last-Month">
         පසුගිය මාසය  <div class="last-month-number"><h1  data-target="10"  class="count">0</h1><p> සිදුවීම්</p></div>
        </div>
        <div class="last-hour">
            <p> පසුගිය</p> <h2>24 පැය</h2><div class="last-hour-number"><h1  data-target="10"  class="count">0 </h1><p>සිදුවීම්</p></div> <h1></h1>   
        </div>
    </div>
        ...
        වනාන්තරයේ සිදු වන නීති විරෝධී දේ<h1  data-target="20"  class="count">0</h1>
         ...
         අලි වැට වාර්තාව බිඳවැටීම <h1  data-target="16"  class="count">0</h1>
            ...
            <div class="update-col">
             පොළොන්නරුව දිස්ත්රික් සිදුවීම් වාර්තා ප්රතිශතය <h1  data-target="90"  class="count">0 </h1><h2>%</h2>
            </div> 
         </div>
    ...
    <div class="main-update-col-3">
        <div class="last-week-1">
         ගිය සතිය <div class="last-week-number-1"><h1  data-target="11"  class="count" >0</h1><p> incidents </p></div>
        </div>
        <div class="last-Month-1">
         පසුගිය මාසය   <div class="last-month-number-1"><h1  data-target="20"  class="count" >0</h1><p> incidents</p></div>
        </div>
        <div class="last-hour-1">
            <p> පසුගිය</p> <h2>24 පැය</h2><div class="last-hour-number-1"><h1 data-target="12"  class="count">0</h1><p>Incidents</p></div> <h1></h1>   
        </div>
    </div>
     <div class="map">
