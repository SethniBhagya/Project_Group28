...
<head>
    ...
    <title>காட்டு விலங்கு ஆபத்து</title>
</head>
    ...
    <div class="container1-1">
        ...
        <form class="form-report" action="" method="post">
            <div class="form-rp">
                ...
                <label for="numberOfelephants"><b>விலங்குகள் : </b></label>
                ...
                <input type="radio" name="support" id="" value="no"><br><br>
