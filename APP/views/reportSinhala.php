    ...
    <header id="main">
        ...
        <nav id="navbar" class="mybar">
            ...
            <li id="home_2"><a href="../?lang=2">මුල් පිටුව</a></li>
                ...
                <li id="report_2" style="   padding-right:20px ; right:345px ; background-color: rgb(168, 175, 168); " ><a href="../incident/index?lang=2"> වර්තා කිරීම</a></li>
...
<?php }else{
   ...
   ?>        <?php if (isset($_POST['Submit'])) {
    ...
    <div class="report-name" style="display:none">
        <h1>පහත අයිකනය මත ක්ලික් කිරීමෙන් වාර්තා කරන්න</h1>
    </div>
 
    <div class="container-1">
       
        <button  class="report-1-1" ><a index="rep" class="report-1" href="./setIncident?lang=2&report=1"> <span class="dot1"><img class="report2" src="../Public/images/report-1.png"></span></br>
    ...
    <div class="container-2">
        ...
        <button class="report-6-6" href="" ><a class="report-6" href="./setIncident?lang=2&report=6"><span class="dot5"><img class="report5" src="../Public/images/illegal.png"></span>
