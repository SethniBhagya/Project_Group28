    ...
    <div id="myview" class="view-1">
         <div class="subcontainer_3-5">
            <div class="subcontainer_3-6">
                ...
                <h3 style="color: white;">View Villager NIC <?php echo $_GET['NIC'] ?> </h3>
                </div>
      ...
      ?>
          ...
          <div id="message1" style="padding: 10px; background-color:aliceblue">
           ...
           <p style="color: darkred;">
                 Villager NIC <?php echo $_GET['NIC'] ?>
           </p>
    ...
    <?php
      ...
      ?>
          ...
          <div id="message1" style="padding: 10px; background-color:aliceblue">
           ...
           <a href="../gramaniladari/viewVillager?status=pending&page=1&lang=1"  class="login-btn" style=" border-radius: 10px; padding: 10px 10px; background-color:#056412;  color: white;">View Report</a>
           </div>
          </div>
         <?php
