...
<head>
  ...
  <link rel="stylesheet" href="../Public/css/report_3_update.css">
  <script src="../Public/javascript/login1.js"></script>
  <script src="../Public/javascript/report3.js"></script>
  <title>Bயானை வேலிகள் உடைப்பு</title>
</head>
...
<body>
  ...
  <div class="container1-1">
    <div class="header">
      <b>யானை வேலிகள் உடைப்பு <br><br>அறிக்கை எண் :<?php echo "  " . $_GET['reportNo']; ?> </b>
    </div>
