...
<head>
    ...
    <title>காட்டு யானைகள் கிராமத்தில் உள்ளன</title>
</head>
...
<body>
    ...
    <div class="container1-1">
        <div class="header">
            <b>காட்டு யானைகள் கிராமத்தில் உள்ளன</b>
        </div>
        ...
        <form class="form-report" action="" method="post">
            <div class="form-rp">
                ...
                <label  style="font-size: 100px; font-size: 15px;" for="status"><b>இருப்பிடத்தைக் கண்கா  : </b></label>
                <button onclick="return getLocation()" id="track"  style="font-size: 100px; font-size: 15px;">கிளிக்  </button>
            </div>
