...
<body style="background-image: none; background-color: white;">
    ...
    <div class="first">
        இலங்கையில் மொத்தம்<br>
        <?php


        echo " நாள் -" . date("d/m/Y") ?><br>
    ...
    <div class="district-name">
        <h2>
            ...
            <?php echo $data['district'][0]['address'] ?> மாவட்டம்</h2>
    </div>
    <div class="district-report">
        ...
        <div class="report-3">
            காட்டு விலங்குகள் வருகை <h1 data-target="<?php echo $data['villager'] ?>" class="count"><?php echo $data['lastMonthWildAnimalArrivalDistrict']  ?></h1>
        </div>
        <div class="report-4">
