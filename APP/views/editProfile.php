   ...
   ?>      <?php
    ...
    <div class="contanier_2">
      ...
      <form class="form2" action="" method="post">
          <p>Please make sure you must Update Profile details You must enter your password</p>
        <table id="form1">
          <tr>
            <th>
          ...
          <tr>
            ...
            <th><input class="text" type="password" id="password" name="newPassword" placeholder="Type New password or using password" /></th>
          </tr>
          <tr>
          <tr>
            <th>
            ...
            <th><input class="text" type="password" id="cpassword" name=" " placeholder="Type New password or using password" /></th>
          </tr>
        </table>
        <div class="sumbit2">
