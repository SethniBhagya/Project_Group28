...
<body>
    ...
    <div class="container1-1">
        <div class="header">
            <b>අලි ගම්මානයේ ඇත<br><br>වාර්තා අංකය:<?php echo "  ".$_GET['reportNo']; ?> </b>
        </div>
    <?php 
    ...
    ?>
           ...
           <div id="message1" style="padding: 10px; background-color:aliceblue">
            ...
            <h1>ඔබගේ වාර්තාවේ සිදුවීම් යාවත්කාලීන කිරීම සාර්ථකයි</h1><p style="color: darkred;">
               <!-- Import ! <br> -->
   ...
   <?php
    ...
    ?>
        ...
        <form class="form-report" action="" method="post">
            ...
            <label for="status"><b>හදිසි වාර්තාව :</b></label>
            <input type="radio" name="Reg" id="Reg" value="yes">
            <label for="status"><b>ඔව්</b></label>
            <input type="radio" name="Reg" id="" value="no">
            <label for="status"><b>නැත</b></label><br><br>
             <div class="photo">
            <label for="addPhoto"><b>ඡායාරූපය එකතු කරන්න : </b></label>
            <input type="file" name="Photo" id ="file" class="file" value="<?php $image ?>"> </div>
            </div>
            <div class="location">
                <label class="label-1">සිතියමේ ස්ථානය සලකුණු කරන්න</label>
                <button onclick="return getLocation()">ස්ථානය ක්ලික් කර ලකුණු කරන්නs</button>
            </div>
            <div class="map" id="">
